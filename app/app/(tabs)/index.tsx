import { View, Text, TouchableOpacity, TextInput, Modal, FlatList, Pressable, Image, KeyboardAvoidingView, Platform } from 'react-native';
...
export default function HomeScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <View style={{ paddingHorizontal: 24, paddingVertical: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: colors.headerBg, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 4, elevation: 2, zIndex: 10 }}>
        <Image
          source={require('../../assets/images/icon.png')}
          style={{ width: 36, height: 36, borderRadius: 18 }}
        />
        <Text style={{ fontSize: 20, fontWeight: '700', color: colors.text, letterSpacing: -0.3, textAlign: 'center', flex: 1 }}>Sangwari AI</Text>
        <TouchableOpacity
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <View style={{ flex: 1, paddingHorizontal: 24, paddingTop: 16 }}>
          ...
          <View style={{ backgroundColor: colors.card, borderRadius: 16, padding: 16, marginTop: 14, borderWidth: 1, borderColor: colors.cardBorder }}>
            ...
            <View style={{ backgroundColor: isDark ? '#3B1010' : '#FEF2F2', borderRadius: 12, padding: 12, borderWidth: 1, borderColor: isDark ? '#5C1E1E' : '#FECACA' }}>
              ...
              <Text style={{ fontSize: 12, color: colors.textSecondary, marginBottom: 1 }}>
        ...
        {/* Complaint Input Bar + Footer */}
        <View style={{ backgroundColor: colors.headerBg, borderTopWidth: 1, borderTopColor: colors.cardBorder, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 6 }}>
          <View style={{ flexDirection: 'row', alignItems: 'flex-end' }}>
            <Pressable
              style={{ flex: 1, backgroundColor: colors.inputBg, borderRadius: 20, paddingHorizontal: 16, paddingVertical: 12, minHeight: 48, marginRight: 12, justifyContent: 'center' }}
              onPress={() => inputRef.current?.focus()}
            >
              <TextInput
                ref={inputRef}
                style={{ color: colors.text, fontSize: 15, maxHeight: 80 }}
